                    ...
                    <>
                      ...
                      <View className="mb-6 rounded-xl bg-blue-50 p-4">
                        ...
                        <Text className="mt-2 text-sm text-blue-800">
                          Se você apenas deseja fazer uma pausa, basta sair do aplicativo. Seus
                          dados permanecerão seguros e você poderá voltar a qualquer momento.
                        </Text>
                      </View>
                      ...
                      <View className="mb-4 rounded-xl border-2 border-gray-200 p-4">
                        <Text className="mb-2 text-sm font-medium text-text-dark">
                          ...
                          <Text className="font-bold text-error">DELETAR</Text> abaixo:
                        </Text>
                        <TextInput
                          value={confirmText}
