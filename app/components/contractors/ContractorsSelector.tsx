...
const ContractorsSelector: React.FC<ContractorsSelectorProps> = ({
  selectedContractorId,
  onContractorSelect,
  title = 'Contratante',
  required = false,
}) => {
  const { contractors, contractorOptions, isLoading, loadContractors } = useContractorsSelector();
  ...
  const renderContractorItem = (contractor: Contractor, isSelected: boolean) => (
    <TouchableOpacity
      key={contractor.id}
      ...
      onPress={() => onContractorSelect(contractor.id)}>
